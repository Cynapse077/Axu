...
public class WorldMap_Test : MonoBehaviour
{
    ...
    IEnumerator GenNewMap(int width, int height)
    {
        map = Generate_WorldMap.Generate(new System.Random(seed), width, height, layers, outerScale, innerScale).mapData;
    ...
    public void Display()
    {
        ...
        StartCoroutine(GenNewMap(width, height));
    }
