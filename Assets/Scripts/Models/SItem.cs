...
public class SQuest {
	...
	public string QG;
	public string LQ;
	public string FRules;
	public int Flag;

	public SQuest(string name, string id, string desc, string endd, List<QuestStep> stps, List<QuestEvent> events, string qgiver, string linkQ, string frl, int flg, Quest.QuestRewards rwd) {
